import"./bootstrap.min-66c8f441.js";import{A as n}from"./config-ca05e4f1.js";const o=document.querySelector(".news-content"),i=document.querySelector(".page-button"),s=window.location.href.split("?id=").pop(),c=document.querySelector(".breadcrumb");axios.get(`${n}/latestNews?id=${s}`).then(a=>{let l=a.data;m(l)});function m(a){let l=`
