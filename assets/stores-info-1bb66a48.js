import"./bootstrap.min-feac71ab.js";import{a as t}from"./axios-28bc18a3.js";import{A as c}from"./config-ca05e4f1.js";import{d as f,a as p}from"./api-c9e20ce4.js";const h=document.querySelector("#storeInfo");let o=[],n=[];const g=document.querySelector(".breadcrumb"),a=window.location.href.split("?id=").pop(),r=sessionStorage.getItem("user_id");t.get(`${c}/shops?id=${a}`).then(async s=>{o=s.data,y(),m(),await v(),w(),I()}).catch(s=>{console.error("Error fetching data:",s)});let d;async function v(){try{d=(await t.get(`${c}/userShopCollections?userId=${r}&shopId=${a}`)).data.length===1}catch(s){console.error("Error fetching data:",s)}}const y=()=>{let s="";o.forEach(e=>{s+=`
