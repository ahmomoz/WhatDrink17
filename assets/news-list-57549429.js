import"./bootstrap.min-823dfcbc.js";const m=document.querySelector(".newsArea");function y(i){let c="";for(let a=0;a<i.length;a++){const l=i[a].Description.substring(0,100);c+=`<div class="col-12 news-card mb-0" id="newsCard">
