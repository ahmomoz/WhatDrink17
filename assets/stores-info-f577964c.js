import"./bootstrap.min-1997008c.js";import{a as t}from"./axios-28bc18a3.js";const d=document.querySelector("#storeInfo");let a=[],o=[];const m=document.querySelector(".breadcrumb"),u=window.location.href.split("?id=").pop();t.get(`https://json-server-project-wtkt.onrender.com/shops?id=${u}`).then(s=>{a=s.data,f(),r(),p(),h()}).catch(s=>{console.error("Error fetching data:",s)});const f=()=>{let s="";a.forEach(e=>{s+=`
