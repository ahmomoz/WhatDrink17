import"./bootstrap.min-feac71ab.js";import{e as N,c as U,a as j,d as G}from"./api-4c8ad0b6.js";import{A as h}from"./config-ca05e4f1.js";const R=sessionStorage.getItem("jwtToken"),P=sessionStorage.getItem("user_email"),m=sessionStorage.getItem("user_id"),$=sessionStorage.getItem("user_nickname"),I=sessionStorage.getItem("user_picture");function Y(){return R?!0:(w(),!1)}Y();function w(){window.location.href="logIn.html"}const E=document.querySelector("#logout-button");E&&E.addEventListener("click",function(){sessionStorage.clear(),w()});const z=document.querySelector("#modifyPasswordButton");z.addEventListener("click",function(n){n.preventDefault(),window.location.href="modifyPassword.html"});const W=document.querySelector(".userData"),D=document.querySelector(".drinkCollections"),L=document.querySelector(".shopCollectionsArea");function F(){const n=I===null?"/assets/images/member.png":I;W.innerHTML=`
