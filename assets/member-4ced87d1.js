import"./bootstrap.min-1997008c.js";const l=document.querySelector(".userData"),i=document.querySelector(".drinkCollections"),a=document.querySelector(".shopCollectionsArea");function n(s){l.innerHTML=`
