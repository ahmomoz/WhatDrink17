import"./bootstrap.min-328bce5f.js";import{a as m}from"./axios-28bc18a3.js";const b=document.querySelector("#lastestNews");let f=[];function k(){let e="";f.forEach(function(t){e+=`
      ...
      `}),b.innerHTML=e}m.get("https://json-server-project-wtkt.onrender.com/latestNews").then(e=>{f=e.data,k()});const v=document.querySelector("#popularDrinkList");let d=[],p=[],n=[],h=[];const x=()=>{const e=d.map(o=>o.Ingredients.length===0?`${o.TeaType}`:`${o.TeaType},${o.Ingredients}`),t=[];for(let o=0;o<e.length;o++)t.push(e[o].split(","));let r="",a=[];t.forEach(o=>{o.forEach((s,l)=>{r+=`<li class="drinks-tag">${s}</li>`,l===o.length-1&&(a.push(r),r="")}),p.push(a),a=[]})};function y(){let e={};for(var t=0;t<n.length;t++){let s=n[t].drinkId;e[s]?e[s]++:e[s]=1}const r=Object.entries(e);r.sort(function(s,l){return l[1]-s[1]});let o=r.slice(0,6).map(function(s){return s[0]});d.forEach(function(s){o.forEach(function(l){l==s.id&&h.push(s)})})}const w=()=>{let e="";h.forEach(t=>{e+=`
...
`}),v.innerHTML=e},S=()=>{w()};function E(){document.querySelectorAll(".collect-btn").forEach(function(t){t.addEventListener("click",function(r){r.target.value=="collected"?(t.value="uncollect",t.classList.remove("fa-regular"),t.classList.add("fa-solid")):r.target.value=="uncollect"&&(t.value="collected",t.classList.add("fa-regular"),t.classList.remove("fa-solid"))})})}axios.get("https://json-server-project-wtkt.onrender.com/drinks").then(e=>{d=e.data}).catch(e=>{console.error("Error fetching data:",e)});axios.get("https://json-server-project-wtkt.onrender.com/userDrinkCollections").then(e=>{n=e.data,y(),x(),S(),E()}).catch(e=>{console.error("Error fetching data:",e)});const $=document.querySelector("#popularStoreList");let u=[],g=[],c=[],i=[];const L=()=>{u.forEach(e=>{const t={uber:"uber eat",foodpanda:"food panda",hasEvent:"合作活動"};let r="";for(const a in t)e[a]&&(r+=`<li class="stores-tag">${t[a]}</li>`);g.push(r),r=""})};function I(){let e={};for(var t=0;t<c.length;t++){let s=c[t].shopId;e[s]?e[s]++:e[s]=1}const r=Object.entries(e);r.sort(function(s,l){return l[1]-s[1]});let o=r.slice(0,4).map(function(s){return s[0]});u.forEach(function(s){o.forEach(function(l){l==s.id&&i.push(s)})}),console.log(i)}const D=()=>{let e="";i.forEach(t=>{e+=`
        ...
        `}),$.innerHTML=e},T=()=>{D()};function j(){document.querySelectorAll(".collect-btn").forEach(function(t){t.addEventListener("click",function(r){r.target.value=="collected"?(t.value="uncollect",t.classList.remove("fa-regular"),t.classList.add("fa-solid")):r.target.value=="uncollect"&&(t.value="collected",t.classList.add("fa-regular"),t.classList.remove("fa-solid"))})})}axios.get("https://json-server-project-wtkt.onrender.com/shops").then(e=>{u=e.data}).catch(e=>{console.error("Error fetching data:",e)});axios.get("https://json-server-project-wtkt.onrender.com/userShopCollections").then(e=>{c=e.data,I(),L(),T(),j()}).catch(e=>{console.error("Error fetching data:",e)});
