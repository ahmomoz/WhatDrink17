import"./bootstrap.min-dcd01d0b.js";const m=document.querySelector("#drinkList");let b=document.querySelector("#teaTypeSelect"),f=document.querySelector("#ingredientsSelect"),o=[],g=[];const E=()=>{const e=o.map(a=>a.Ingredients.length===0?`${a.TeaType}`:`${a.TeaType},${a.Ingredients}`),t=[];for(let a=0;a<e.length;a++)t.push(e[a].split(","));let n="",c=[];t.forEach(a=>{a.forEach((u,p)=>{n+=`<li class="drinks-tag">${u}</li>`,p===a.length-1&&(c.push(n),n="")}),g.push(c),c=[]})},P=()=>{let e="";o.forEach(t=>{e+=`
