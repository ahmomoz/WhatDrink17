import"./bootstrap.min-141e3aaa.js";import{a}from"./axios-28bc18a3.js";const l=document.querySelector("#branchesList");let n=[];const t=window.location.href.split("?id=").pop();a.get(`https://json-server-project-wtkt.onrender.com/shopBranches?shopId=${t}`).then(s=>{n=s.data,c()}).catch(s=>{console.error("Error fetching data:",s)});const r=()=>{let s="";n.forEach(e=>{s+=`              
