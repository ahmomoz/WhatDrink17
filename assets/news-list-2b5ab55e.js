import"./bootstrap.min-feac71ab.js";import{A as y}from"./config-ca05e4f1.js";const m=document.querySelector(".newsArea");function k(i){let d="";for(let a=0;a<i.length;a++){const l=i[a].Description.substring(0,100);d+=`<div class="col-12 news-card mb-0" id="newsCard">
    ...
    <hr class="mb-40 mt-20 mt-lg-40">`}m.innerHTML=d}const B=i=>{const d=i.length,a=5,l=Math.ceil(d/a);let n=1;function p(t){const c=(t-1)*a,s=c+a,r=i.slice(c,s);b(r),u()}function b(t){m.innerHTML="";let c="";for(let s=0;s<t.length;s++){const r=t[s].Description.substring(0,100);c+=`<div class="col-12 news-card mb-0" id="newsCard">
            <div class="card border-0">
                <div class="row">
                    <div class="col-12 col-lg-6 px-12">
        ...
        <hr class="mb-40 mt-20 mt-lg-40">`}m.innerHTML=c}function u(){const t=document.getElementById("pagination");t.innerHTML="";let c="";for(let e=1;e<=l;e++)c+=`
