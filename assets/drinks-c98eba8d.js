import"./bootstrap.min-33c36378.js";const o=document.querySelector("#drinkList");let r=document.querySelector("#teaTypeSelect"),c=document.querySelector("#ingredientsSelect"),n=[],i=[];const f=()=>{const t=n.map(a=>a.Ingredients.length===0?`${a.TeaType}`:`${a.TeaType},${a.Ingredients}`),e=[];for(let a=0;a<t.length;a++)e.push(t[a].split(","));let l="",s=[];e.forEach(a=>{a.forEach((u,p)=>{l+=`<li class="drinks-tag">${u}</li>`,p===a.length-1&&(s.push(l),l="")}),i.push(s),s=[]})},g=()=>{let t="";n.forEach(e=>{t+=`
