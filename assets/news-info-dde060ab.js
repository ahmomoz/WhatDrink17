import"./bootstrap.min-328bce5f.js";const a=document.querySelector(".news-content"),r=document.querySelector(".page-button"),s=window.location.href.split("?id=").pop(),n=document.querySelector(".breadcrumb");axios.get(`https://json-server-project-wtkt.onrender.com/latestNews?id=${s}`).then(e=>{let t=e.data;c(t)});function c(e){let t=`
