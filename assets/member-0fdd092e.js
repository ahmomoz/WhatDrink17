import"./bootstrap.min-0bbeed66.js";const l=document.querySelector(".userData"),i=document.querySelector(".drinkCollections"),a=document.querySelector(".shopCollectionsArea");function n(s){l.innerHTML=`
