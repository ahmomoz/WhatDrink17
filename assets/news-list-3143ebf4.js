import"./bootstrap.min-7e310722.js";const m=document.querySelector(".newsArea");function y(i){let c="";for(let a=0;a<i.length;a++){const l=i[a].Description.substring(0,100);c+=`<div class="col-12 news-card mb-0" id="newsCard">
    ...
    <hr class="mb-40 mt-20 mt-lg-40">`}console.log(c),m.innerHTML=c}const k=i=>{const c=i.length,a=5,l=Math.ceil(c/a);let n=1;function p(t){const d=(t-1)*a,s=d+a,r=i.slice(d,s);b(r),u()}function b(t){m.innerHTML="";let d="";for(let s=0;s<t.length;s++){const r=t[s].Description.substring(0,100);d+=`<div class="col-12 news-card mb-0" id="newsCard">
            <div class="card border-0">
                <div class="row">
                    <div class="col-12 col-lg-6 px-12">
        ...
        `;const s=n===1?"text-gray":"",r=n===l?"text-gray":"",f=n===1?"disabled":"",h=n===1?"disabled":"",x=n===l?"disabled":"",P=n===l?"disabled":"";t.innerHTML=`
        ...
        <li id="next-page-btn" class="page-item mx-4 d-none d-md-block ${x}">
