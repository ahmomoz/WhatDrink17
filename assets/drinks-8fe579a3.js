import"./bootstrap.min-5c03cf19.js";const p=document.querySelector("#drinkList");let f=document.querySelector("#teaTypeSelect"),k=document.querySelector("#ingredientsSelect"),o=[],m=[];const P=()=>{const t=o.map(e=>e.Ingredients.length===0?`${e.TeaType}`:`${e.TeaType},${e.Ingredients}`),a=[];for(let e=0;e<t.length;e++)a.push(t[e].split(","));let l="",s=[];a.forEach(e=>{e.forEach((u,b)=>{l+=`<li class="drinks-tag">${u}</li>`,b===e.length-1&&(s.push(l),l="")}),m.push(s),s=[]})},B=()=>{let t="";o.forEach(a=>{t+=`
