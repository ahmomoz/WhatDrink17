import"./bootstrap.min-7e310722.js";const l=document.querySelector(".userData"),i=document.querySelector(".drinkCollections"),a=document.querySelector(".shopCollectionsArea");function n(s){l.innerHTML=`
