import"./bootstrap.min-141e3aaa.js";const l=document.querySelector(".newsArea");function c(e){let t="";for(let s=0;s<e.length;s++){const i=e[s].Description.substring(0,100);t+=`<div class="col-12 news-card mb-0" id="newsCard">
